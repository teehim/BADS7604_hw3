...
- LSTM ใช้เวลาในการ Train น้อยที่สุด แต่ความแม่นยำต่ำที่สุดในกลุ่ม RNN ด้วยกัน ในขณะที่ GRU ใช้เวลาในการ Train นานที่สุด แต่ความแม่นยำก็สูงที่สุดเช่นกัน
- 
